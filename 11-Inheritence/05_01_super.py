...
class Programmer(Employee):
    company = "Fiverr"              # Try uncommenting
    ...
    def takeBreath(self):
        ...
        print(super().country)
        print('Programmer\'s Parent company: '+super().company)
        print('Programmer\'s company: '+self.company)


# NOTE: the difference in constructors
# In Java, child class constructor automatically calls parent class constructors
# But in Python this happens if constructors are not specifically defined. (Default constructors are present)
